...
class DiscordReactionBot {
    ...
    async initialize() {
        try {
            ...
            // Don't store a local copy - always get from ConfigManager
            // this.config = this.configManager.getConfig(); // REMOVED
    ...
    getConfig() { return this.configManager.getConfig(); } // Always get from ConfigManager
